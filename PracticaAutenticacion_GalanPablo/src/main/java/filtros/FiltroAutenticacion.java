...
public class FiltroAutenticacion implements Filter {
    ...
    private static final String[] urlPublicas= {"home.jsp","index.jsp","/styles/index.css","login","registrarPokemon"};
    ...
    /**
     * Verifica que hay una sesion activa y que el usuario se encuentre autentificado
     * @param httpRequest
     * @return 
     */
    ...
    /**
     * Verifica si la ruta que quiere acceder es privada
     * @param ruta 
     * @return 
     */
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String ruta= this.getRutaSolicitada(httpsRequest);
        boolean urlPrivada=  this.esUrlPrivada(ruta);
        boolean logueado= this.estaLogueado(httpsRequest);
        
        if(!logueado && urlPrivada){
            httpsResponse.sendRedirect(httpsRequest.getContextPath() + "/index.jsp");
        }else{
